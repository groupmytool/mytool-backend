...
import static group.mytool.backend.core.exception.EnumGlobalError.PARAM_ILLEGAL;
import static group.mytool.backend.core.exception.EnumGlobalError.SYSTEM_ERROR;
